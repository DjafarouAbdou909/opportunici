...
from .services.score_calculator import calculer_score_employabilite
from .models import (
        ...
        if form.is_valid():
            ...
            try:
                ...
                for competence in donnees_profil.get('competences_techniques') or []:
                    CompetenceTechnique.objects.create(profil=profil, nom=competence)
                ...
                profil_data = {
                    ...
                    'soft_skills': list(profil.soft_skills.values_list('nom', flat=True)),
                    'formations': [{'diplome': f.diplome, 'etablissement': f.etablissement} for f in profil.formations.all()],
                    ...
                    'certifications': donnees_profil.get('certifications') or [],
                }

                score_data = calculer_score_employabilite(profil_data)

                ScoreEmployabilite.objects.update_or_create(
                    profil=profil,
                    defaults={
